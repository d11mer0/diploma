...
TECH_DOMAIN_MAP = {
    ...
    "sketch": ["A.10"],
    "adobe xd": ["A.10"],
    "дизайн інтерфейсу": ["A.10", "A.6"],
    "дизайн інтерфейсів": ["A.10", "A.6"],
    "інтерфейс користувача": ["A.10", "A.6"],
    "інтерфейси користувача": ["A.10", "A.6"],
    "користувацький досвід": ["A.10"],
    "прототипування": ["A.10", "A.6"],
    "юзабіліті": ["A.10", "B.3"],
    "тестування юзабіліті": ["A.10", "B.3"],
    "дизайн-системи": ["A.10", "A.6"],

    # Requirements Engineering & Needs Identification (D.11)
    "інженерія вимог": ["D.11", "A.3"],
    "аналіз вимог": ["D.11", "A.3"],
    "збір вимог": ["D.11"],
    "вимоги до програмного забезпечення": ["D.11", "A.3"],
    "business analysis": ["D.11", "A.3"],
    "requirements engineering": ["D.11"],
    "use cases": ["D.11", "A.6"],
    "use case": ["D.11", "A.6"],
    "user stories": ["D.11", "A.6"],
    "user story": ["D.11", "A.6"],

    # Systems Engineering, Embedded & IoT (B.6)
    "інтернет речей": ["B.6", "B.1"],
    "вбудовані системи": ["B.6", "B.1"],
    "мікроконтролери": ["B.6"],
    "системне проектування": ["B.6", "A.5"],
    "iot": ["B.6", "B.1"],
    "embedded": ["B.6"],
    ...
    "управління якістю": ["E.6", "D.2"],
    "стандарти якості": ["D.2", "E.6"],
    "контроль якості": ["E.6", "B.3"],
    "iso 9001": ["D.2", "E.6"],

    # Governance & Process Optimization (E.5, E.9)
    "itil": ["E.9", "C.3", "E.5"],
    "cobit": ["E.9"],
    "іт-аудит": ["E.9", "E.8"],
    "управління іт": ["E.9", "E.2"],
    "оптимізація процесів": ["E.5", "E.3"],
    "покращення процесів": ["E.5"],
    "bpmn": ["E.5", "D.11"],
